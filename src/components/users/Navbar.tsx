  ...
  return (
    ...
    <div className='sm:hidden'>
      ...
      <ul className='font-sans  font-bold flex gap-28  '>
        <li className='text-gray-300 hover:text-white hover:cursor-pointer '>HOME</li>
        <li className='text-gray-300 hover:text-white hover:cursor-pointer '>ABOUT</li>
        <li className='text-gray-300 hover:text-white hover:cursor-pointer '>TRAINERS</li>
